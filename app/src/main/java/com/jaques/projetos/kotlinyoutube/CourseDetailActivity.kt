...
//        recyclerView_Main.adapter = CourseDetailAdapter()
    ...
    private fun fetchJSON(): Unit {
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onFailure(call: Call, e: IOException) {
                println("Failed to execute request Course Detail")
            }
        })
    }
    ...
    private class CourseDetailAdapter(val courseLessons: Array<CourseLesson>) :
        ...
        override fun onBindViewHolder(holder: CourseLessonViewHolder, position: Int) {
                ...
                val imageView = holder.customView.imageView_course_thumbnail
     ...
     class CourseLessonViewHolder(val customView: View, var courseLesson: CourseLesson? =null) :
        ...
        companion object{
            val COURSE_LESON_LINK_KEY = "COURSE_LESSON_LINK"
        }
        ...
        init {
            customView.setOnClickListener {
                ...
                intent.putExtra(COURSE_LESON_LINK_KEY, courseLesson?.link )
